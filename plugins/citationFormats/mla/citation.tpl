...
{if $smarty.foreach.authors.first}{$author->getLocalizedLastName()|escape}, {$author->getLocalizedFirstName()|escape}{else}{$author->getFullName()|escape}{/if}{if $i==$authorCount-2}, & {elseif $i lt $authorCount-1}, {else}.{/if}
{/foreach}
